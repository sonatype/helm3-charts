...
| `image.repository`                         | Nexus Repository image repository                                                                      | `sonatype/nexus3`                                                                                                                                  |
| `image.tag`                                | Nexus Repository image tag                                                                      |                                                                                                                                   |
| `image.pullPolicy`                         | Nexus Repository image pull policy                                                                      | `IfNotPresent`                                                                                                                                  |
